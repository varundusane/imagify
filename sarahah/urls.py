...
urlpatterns = [
    url(r'', include((core, 'core'),namespace='core')),
    url(r'^admin/', admin.site.urls),
    url(r'accounts/', include((accounts, 'accounts'),namespace='account')),
    url(r'messages/', include((messages, 'smessages'),namespace='message')),
